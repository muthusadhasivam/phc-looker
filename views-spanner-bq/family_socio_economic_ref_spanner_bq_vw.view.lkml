...
# explore: family_socio_economic_ref_spanner_bq_vw {
#   hidden: yes

#   join: family_socio_economic_ref_spanner_bq_vw__update_register {
#     view_label: "Family Socio Economic Ref Vw: Update Register"
#     sql: LEFT JOIN UNNEST(${family_socio_economic_ref_spanner_bq_vw.update_register}) as family_socio_economic_ref_spanner_bq_vw__update_register_timestamp ;;
#     relationship: one_to_many
#   }
# }

view: family_socio_economic_ref_spanner_bq_vw {
  sql_table_name: `cobalt-catalyst-318208.TNPHR_Spanner.family_socio_economic_ref_spanner_bq_vw`
    ;;
...
view: family_socio_economic_ref_spanner_bq_vw__update_register {
  dimension: family_socio_economic_ref_spanner_bq_vw__update_register_timestamp {
    type: string
    label: "Updated Timestamp"
    sql: JSON_VALUE(family_socio_economic_ref_spanner_bq_vw__update_register, "$.timestamp") ;;
  }
  dimension: family_socio_economic_ref_spanner_bq_vw__update_register_user_id {
    type: string
    label: "Updated By User Id"
    sql: JSON_VALUE(family_socio_economic_ref_spanner_bq_vw__update_register, "$.user_id") ;;
  }
}
