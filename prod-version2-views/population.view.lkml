view: population {
  ...
  measure: male_population {
    ...
    sql: ${TABLE}.population_count ;;
    value_format: "[>9999999]##\,##\,##\,##0;[>99999]##\,##\,##0;##,##0"
    drill_fields: [citizen_district_name,male_population]
  }
  ...
  measure: female_population {
    ...
    sql: ${TABLE}.population_count ;;
    value_format: "[>9999999]##\,##\,##\,##0;[>99999]##\,##\,##0;##,##0"
    drill_fields: [citizen_district_name,female_population]
  }
  ...
  measure: other_population {
    ...
    sql: ${TABLE}.population_count ;;
    value_format: "[>9999999]##\,##\,##\,##0;[>99999]##\,##\,##0;##,##0"
    drill_fields: [citizen_district_name,other_population]
  }
  ...
  measure: resident_status_resident {
    ...
    {% endif %};;
    drill_fields:[citizen_district_name,resident_status_resident]
  }
  ...
  measure: resident_status_resident_no_html {
    ...
    sql: ${TABLE}.population_count ;;
    value_format: "[>9999999]##\,##\,##\,##0;[>99999]##\,##\,##0;##,##0"
    drill_fields:[citizen_district_name,resident_status_resident_no_html]
  }
  ...
  measure: resident_status_migrated {
    ...
    {% endif %};;
    drill_fields:[citizen_district_name,resident_status_migrated]
  }
  ...
  measure: resident_status_death {
    ...
    {% endif %};;
    drill_fields:[citizen_district_name,resident_status_death]
  }
  ...
  measure: resident_status_death_no_html{
    ...
    sql: ${TABLE}.population_count ;;
    value_format: "[>9999999]##\,##\,##\,##0;[>99999]##\,##\,##0;##,##0"
    drill_fields:[citizen_district_name,resident_status_death_no_html]
  }
  ...
  measure: resident_status_duplicate {
    ...
    {% endif %};;
    drill_fields:[citizen_district_name,resident_status_duplicate]
  ...
  measure: resident_status_non_traceable {
    ...
    {% endif %};;
    drill_fields:[citizen_district_name,resident_status_non_traceable]
  }
