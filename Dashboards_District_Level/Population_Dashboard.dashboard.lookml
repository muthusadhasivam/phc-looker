- dashboard: population_dashboard_d
  title: Population Dashboard D
  layout: newspaper
  ...
  - title: Verified Population
    ...
    filters:
      ...
      family_member_master.resident_status: Resident,resident,Death,Duplicate,Dead,Migrated
        out,Non traceable,Non-traceable,Migrant
    sorts: [family_member_master.count desc]
    limit: 5000
    dynamic_fields: [{table_calculation: total_population, label: Total Population,
        expression: 'sum(${family_member_master.count})', value_format: !!null '',
  ...
  - title: Eligible Couple Target
    ...
    dynamic_fields: [{table_calculation: male_population_married, label: Male Population
          - Married, expression: 'sum(${family_member_master.Male_Population})', value_format: !!null '',
        value_format_name: !!null '', _kind_hint: measure, _type_hint: number}, {
        table_calculation: female_population_married, label: Female Population - Married,
        expression: 'sum(${family_member_master.Female_Population})', value_format: !!null '',
        value_format_name: !!null '', _kind_hint: measure, _type_hint: number}]
    x_axis_gridlines: false
    y_axis_gridlines: true
    show_view_names: false
