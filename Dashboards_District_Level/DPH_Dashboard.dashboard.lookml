- dashboard: dph_dashboard_kpis_d
  title: DPH Dashboard KPIs D
  layout: newspaper
  ...
  - title: District Wise
    ...
    type: looker_grid
    fields: [health_screening.Total_Screening, health_screening.Total_population,
      health_screening.Confirmed_Diabetes_mellitus, health_screening.Controlled_Diabetes_Mellitus,
      health_screening.DM_Percent, health_screening.Confirmed_Hypertension, health_screening.Controlled_Hypertension,
    ...
    column_order: [family_member_master.district_name, health_screening.Total_population,
    ...
    series_labels:
      ...
      health_screening.Total_population: Total Population (Age >18)
      health_screening.Total_Screening: Total Screening (Age >18)
      health_screening.Confirmed_Diabetes_mellitus: Confirmed Diabetes (Age >18)
      health_screening.Controlled_Diabetes_Mellitus: Controlled Diabetes (Age >18)
      health_screening.Controlled_Hypertension_and_Diabetes_Mellitus: Controlled both
        (Age >18)
      health_screening.Confirmed_Hypertension_and_DiabetesMellitus: Confirmed both  (Age
        >18)
      ...
      health_screening.DM_Percent: Diabetes % (Age >18)
      health_screening.Confirmed_Hypertension: Confirmed HT (Age >18)
      health_screening.Controlled_Hypertension: Controlled HT (Age >18)
      health_screening.HT_Percent: HT % (Age >18)
      health_screening.HTDM_Percent: HT and Diabetes %  (Age >18)
    series_column_widths:
      family_member_master.district_name: 241
      health_screening.Total_population: 203
      health_screening.Total_Screening: 198
      health_screening.Confirmed_Diabetes_mellitus: 225
      health_screening.Controlled_Diabetes_Mellitus: 224
      health_screening.DM_Percent: 169
      health_screening.Confirmed_Hypertension: 188
      health_screening.Controlled_Hypertension: 187
      health_screening.HT_Percent: 132
      health_screening.Controlled_Hypertension_and_Diabetes_Mellitus: 197
      health_screening.Confirmed_Hypertension_and_DiabetesMellitus: 198
      health_screening.HTDM_Percent: 218
  ...
  - title: HUD Wise
    ...
    series_labels:
      ...
      health_screening.HTDM_Percent: HT and Diabetes %  (Age >18)
    series_column_widths:
      family_member_master.hud_name: 241
      health_screening.Total_population: 203
      health_screening.Total_Screening: 198
      health_screening.Confirmed_Diabetes_mellitus: 225
      health_screening.Controlled_Diabetes_Mellitus: 224
  ...
  - title: Block Wise
    ...
    series_labels:
      ...
      health_screening.HTDM_Percent: HT and Diabetes %  (Age >18)
    series_column_widths:
      family_member_master.hud_name: 208
      health_screening.Total_population: 203
      health_screening.Total_Screening: 198
      health_screening.Confirmed_Diabetes_mellitus: 225
      health_screening.Controlled_Diabetes_Mellitus: 224
      ...
      health_screening.Confirmed_Hypertension_and_DiabetesMellitus: 198
      health_screening.HTDM_Percent: 218
      family_member_master.block_name: 241
    series_cell_visualizations:
      health_screening.Total_population:
        is_active: false
    series_text_format:
  ...
  - name: Diabetes Mellitus
    ...
    series_types: {}
    dynamic_fields: [{category: table_calculation, expression: "${health_screening.Member_count}-${q1_health_screening.Member_count}",
        label: Uncontrolled, value_format: !!null '', value_format_name: !!null '',
        _kind_hint: measure, table_calculation: uncontrolled, _type_hint: number}]
    listen:
    - Districts: family_member_master.district_name
      Hud Name: family_member_master.hud_name
      Blocks: family_member_master.block_name
