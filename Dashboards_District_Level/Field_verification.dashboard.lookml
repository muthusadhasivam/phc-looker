- dashboard: field_verification_d
  title: Field Verification D
  layout: newspaper
  ...
  - title: Total  Verified Population
    ...
    custom_color: "#EA4335"
    single_value_title: Total Verified Population
    ...
    listen:
      ...
      Villages: address_village_master.village_name
      Districts: family_member_master.district_name
      Role Toggle: health_screening.role_toggle
    row: 3
    col: 4
    width: 4
    height: 3
  - title: Additions in Last 6 Weeks
    ...
    show_silhouette: false
    totals_color: "#808080"
    y_axes: [{label: Count, orientation: left, series: [{axisId: family_master.family_count,
  ...
  - name: District's Wise Counts
    ...
    query_fields:
      ...
      - align: right
        ...
        parameter: false
        primary_key: false
        project_name: looker-tnphr_district_level
        ...
        time_interval:
        lookml_link: "/projects/looker-tnphr_district_level/files/views%2Ffamily_member_master.view.lkml?line=399"
        permanent: true
        source_file: views/family_member_master.view.lkml
        source_file_path: looker-tnphr_district_level/views/family_member_master.view.lkml
        sql: "${TABLE}.member_id "
        sql_case:
        filters:
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_district_level/files/views%2Ffamily_member_master.view.lkml?line=380"
        permanent: true
        source_file: views/family_member_master.view.lkml
        source_file_path: looker-tnphr_district_level/views/family_member_master.view.lkml
        sql: "${TABLE}.member_id "
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_district_level/files/views%2Ffamily_member_master.view.lkml?line=421"
        permanent: true
        source_file: views/family_member_master.view.lkml
        source_file_path: looker-tnphr_district_level/views/family_member_master.view.lkml
        sql: "${TABLE}.member_id "
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_district_level/files/views%2Ffamily_member_master.view.lkml?line=410"
        permanent: true
        source_file: views/family_member_master.view.lkml
        source_file_path: looker-tnphr_district_level/views/family_member_master.view.lkml
        sql: "${TABLE}.member_id "
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_district_level/files/views%2Ffamily_member_master.view.lkml?line=369"
        permanent: true
        source_file: views/family_member_master.view.lkml
        source_file_path: looker-tnphr_district_level/views/family_member_master.view.lkml
        sql: "${TABLE}.member_id "
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_district_level/files/views%2Fhealth_screening.view.lkml?line=1301"
        permanent: true
        source_file: views/health_screening.view.lkml
        source_file_path: looker-tnphr_district_level/views/health_screening.view.lkml
      ...
      - align: left
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_district_level/files/views%2Ffamily_member_master.view.lkml?line=98"
        permanent: true
        source_file: views/family_member_master.view.lkml
        source_file_path: looker-tnphr_district_level/views/family_member_master.view.lkml
    ...
    listen:
    - Directorate Name: facility_directorate_master.directorate_name
      Blocks: address_block_master.block_name
      Villages: address_village_master.village_name
      Hud Name: family_member_master.hud_name
      Districts: address_district_master.district_name
      Role Toggle: health_screening.role_toggle
    - Directorate Name: facility_directorate_master.directorate_name
      Blocks: address_block_master.block_name
      Villages: address_village_master.village_name
  ...
  - name: Hud's Wise Counts
    ...
    query_fields:
      ...
      - align: left
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_district_level/files/views%2Ffamily_member_master.view.lkml?line=150"
        permanent: true
        source_file: views/family_member_master.view.lkml
        source_file_path: looker-tnphr_district_level/views/family_member_master.view.lkml
        sql: "${TABLE}.hud_name "
  ...
  - name: Block's Wise Counts
    ...
    query_fields:
      ...
      - align: left
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_district_level/files/views%2Ffamily_member_master.view.lkml?line=67"
        permanent: true
        source_file: views/family_member_master.view.lkml
        source_file_path: looker-tnphr_district_level/views/family_member_master.view.lkml
  ...
  - name: Village's Wise Counts
    ...
    query_fields:
      ...
      - align: left
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_district_level/files/views%2Ffamily_member_master.view.lkml?line=293"
        permanent: true
        source_file: views/family_member_master.view.lkml
        source_file_path: looker-tnphr_district_level/views/family_member_master.view.lkml
  ...
  - title: Families Added
    ...
    filters:
      family_master.reside_status: Permanent
      family_master.district_name: Villupuram
      family_master.block_name: ''
      family_master.hud_name: ''
