- dashboard: facility_performance_d
  title: Facility Performance D
  layout: newspaper
  ...
  - title: Synced in last 30 days
    ...
    comparison_label: ''
    conditional_formatting: [{type: not null, value: !!null '', background_color: "#a4bced",
        font_color: "#02080f", color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2,
          palette_id: 56d0c358-10a0-4fd6-aa0b-b117bef527ab}, bold: false, italic: false,
        strikethrough: false, fields: !!null ''}]
    defaults_version: 1
  ...
  - name: District Wise
    ...
    - model: tnphr_district_level
      ...
      series_cell_visualizations:
        health_screening.facility_family_last_24_hours:
          is_active: false
      x_axis_gridlines: false
      y_axis_gridlines: true
      show_y_axis_labels: true
    ...
    - model: tnphr
      explore: facility_registry
      type: table
      fields: [facility_registry.district_name, facility_registry.facility_synced_in_last_24_hours,
    ...
    query_fields:
      ...
      - align: right
        ...
        time_interval:
        lookml_link: "/projects/looker-tnphr/files/views%2Fhealth_screening.view.lkml?line=1209"
        permanent: true
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr/files/views%2Fhealth_screening.view.lkml?line=1188"
        permanent: true
        source_file: views/health_screening.view.lkml
        source_file_path: looker-tnphr/views/health_screening.view.lkml
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr/files/views%2Fhealth_screening.view.lkml?line=1266"
        permanent: true
        source_file: views/health_screening.view.lkml
        source_file_path: looker-tnphr/views/health_screening.view.lkml
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr/files/views%2Fhealth_screening.view.lkml?line=1150"
        permanent: true
        source_file: views/health_screening.view.lkml
        source_file_path: looker-tnphr/views/health_screening.view.lkml
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr/files/views%2Fhealth_screening.view.lkml?line=1170"
        permanent: true
        source_file: views/health_screening.view.lkml
        source_file_path: looker-tnphr/views/health_screening.view.lkml
        sql: "${family_id} "
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr/files/views%2Fhealth_screening.view.lkml?line=1115"
        permanent: true
        source_file: views/health_screening.view.lkml
        source_file_path: looker-tnphr/views/health_screening.view.lkml
        sql: "${screening_id}"
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr/files/views%2Fhealth_screening.view.lkml?line=1133"
        permanent: true
        source_file: views/health_screening.view.lkml
        source_file_path: looker-tnphr/views/health_screening.view.lkml
        sql: "${screening_id} "
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr/files/views%2Ffacility_registry.view.lkml?line=344"
        permanent: true
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr/files/views%2Ffacility_registry.view.lkml?line=368"
        permanent: true
        source_file: views/facility_registry.view.lkml
        source_file_path: looker-tnphr/views/facility_registry.view.lkml
        sql: "${TABLE}.facility_id "
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr/files/views%2Ffacility_registry.view.lkml?line=400"
        permanent: true
        source_file: views/facility_registry.view.lkml
        source_file_path: looker-tnphr/views/facility_registry.view.lkml
    ...
    hide_totals: false
    hide_row_totals: false
    column_order: ["$$$_row_numbers_$$$", family_member_master.district_name, health_screening.facility_family_last_24_hours,
      health_screening.facility_family_last_30_days, health_screening.Facility_avg_family_screening,
      health_screening.Facility_Drugs_delivered_last_24_hours, health_screening.Facility_Drugs_delivered_last_30_days,
      health_screening.Average_Facility_Drugs, health_screening.Facility_Inidividual_screening_last_24_hours,
  ...
  - name: Hud Wise
    ...
    - model: tnphr
      ...
      filters:
        facility_registry.hud_name: "-NULL"
      sorts: [facility_registry.facility_synced_in_last_24_hours desc]
      limit: 5000
      join_fields:
    ...
    hide_totals: false
    hide_row_totals: false
    column_order: ["$$$_row_numbers_$$$", family_member_master.hud_name, health_screening.facility_family_last_24_hours,
      health_screening.facility_family_last_30_days, health_screening.Facility_avg_family_screening,
      health_screening.Facility_Drugs_delivered_last_24_hours, health_screening.Facility_Drugs_delivered_last_30_days,
      health_screening.Average_Facility_Drugs, health_screening.Facility_Inidividual_screening_last_24_hours,
      health_screening.Facility_Inidividual_screening_last_30_days, health_screening.Facility_avg_Inidividual_screening,
  ...
  - name: Block Wise
    ...
    - model: tnphr
      ...
      filters:
        facility_registry.block_name: "-NULL"
      sorts: [facility_registry.facility_synced_in_last_24_hours desc]
      limit: 5000
      join_fields:
    ...
    hide_totals: false
    hide_row_totals: false
    column_order: ["$$$_row_numbers_$$$", family_member_master.block_name, health_screening.facility_family_last_24_hours,
      health_screening.facility_family_last_30_days, health_screening.Facility_avg_family_screening,
      health_screening.Facility_Drugs_delivered_last_24_hours, health_screening.Facility_Drugs_delivered_last_30_days,
      health_screening.Average_Facility_Drugs, health_screening.Facility_Inidividual_screening_last_24_hours,
      health_screening.Facility_Inidividual_screening_last_30_days, health_screening.Facility_avg_Inidividual_screening,
  ...
  - title: Top 10 Facility Performance
    ...
    filters:
      ...
      facility_registry.block_name: ''
      facility_registry.hud_name: ''
