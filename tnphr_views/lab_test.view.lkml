view: lab_test {
  sql_table_name: `staging-tnphr.KPI.lab_test`
    ;;
  ...
  measure: lab_tests_30_days {
    ...
    # link: {
    #   label: "Community"
    #   url: "/explore/tnphr_kpi/lab_test?fields=lab_test.DRILL_FIELD_Community_lab_tests_30_days*"
    # }
    # link: {
    #   label: "Institution"
    #   url: "/explore/tnphr_kpi/lab_test?fields=lab_test.DRILL_FIELD_Institution_lab_tests_30_days*"
    # }
  }

  # set: DRILL_FIELD_Community_lab_tests_30_days{
  #   fields: [
  ...
  # set: DRILL_FIELD_Institution_lab_tests_30_days{
  #   fields: [
  #     user_district_name
  #     ,lab_tests_30_days
  #   ]
