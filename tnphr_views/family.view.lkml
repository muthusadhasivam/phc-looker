view: family {
  sql_table_name: `staging-tnphr.KPI.family`
    ;;
  ...
  dimension: family_block_name {
    ...
    drill_fields: [family_village_name]
  }
  ...
  dimension: family_hud_name {
    ...
    drill_fields: [family_block_name]
  }
  ...
  measure: count {
   ...
   measure: total_families {
    ...
    # link: {
    #   label: "Community"
    #   url: "/explore/tnphr_kpi/family?fields=family.DRILL_FIELD_Community_total_families*"
    # }
  }

  # set: DRILL_FIELD_Community_total_families{
  #   fields: [
  ...
  measure: total_families_added {
    label: "Total Families Added"
    type: sum
    ...
    # link: {
    #   label: "Community"
    #   url: "/explore/tnphr_kpi/family?fields=family.DRILL_FIELD_Community_total_families_added*"
    # }
  }

  # set: DRILL_FIELD_Community_total_families_added{
  #   fields: [
  #     family_district_name
  #     ,total_families_added
  #   ]
  # }
  ...
  measure: CMCHIS_Beneficiaries {
    ...
    # link: {
    #   label: "Community"
    #   url: "/explore/tnphr_kpi/family?fields=family.DRILL_FIELD_Community_CMCHIS_Beneficiaries*"
    # }
  }

  # set: DRILL_FIELD_Community_CMCHIS_Beneficiaries{
  #   fields: [
  #     family_district_name
  #     ,CMCHIS_Beneficiaries
  #   ]
  # }
