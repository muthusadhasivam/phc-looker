view: drugs {
  sql_table_name: `staging-tnphr.KPI.drugs`
    ;;
  ...
  measure: total_drugs_issued {
    ...
    # link: {
    #   label: "Community"
    #   url: "/explore/tnphr_kpi/drugs?fields=drugs.DRILL_FIELD_Community_total_drugs_issued*"
    # }
    # link: {
    #   label: "Institution"
    #   url: "/explore/tnphr_kpi/drugs?fields=drugs.DRILL_FIELD_Institution_total_drugs_issued*"
    # }
  }

  # set: DRILL_FIELD_Community_total_drugs_issued{
  #   fields: [
  ...
  # set: DRILL_FIELD_Institution_total_drugs_issued{
  #   fields: [
  #     user_district_name
  #     ,total_drugs_issued
  #   ]
  ...
  # measure: total_drugs_issued_drug_name {
  #   label: "Total drugs issued - Drug name"
  #   type: sum
  #   sql: ${TABLE}.total_drugs_count ;;
  #   value_format: "[>9999999]##\,##\,##\,##0;[>99999]##\,##\,##0;##,##0"
  #   link: {
  #     label: "Community"
  #     url: "/explore/tnphr_kpi/drugs?fields=drugs.DRILL_FIELD_Community_total_drugs_issued_drug_name*"
  #   }
  #   link: {
  #     label: "Institution"
  #     url: "/explore/tnphr_kpi/drugs?fields=drugs.DRILL_FIELD_Institution_total_drugs_issued_drug_name*"
  #   }
  # }

  # set: DRILL_FIELD_Community_total_drugs_issued_drug_name{
  #   fields: [
  #     citizen_district_name,
  #     drug_name
  #     ,total_drugs_issued_drug_name
  #   ]
  # }

  # set: DRILL_FIELD_Institution_total_drugs_issued_drug_name{
  #   fields: [
  #     user_district_name,
  #     drug_name
  #     ,total_drugs_issued_drug_name
  ...
  # link: {
  #   label: "Community"
  #   url: "/explore/tnphr_kpi/drugs?fields=drugs.DRILL_FIELD_Community_total_drugs_issued_30_days*"
  # }
  # link: {
  #   label: "Institution"
  #   url: "/explore/tnphr_kpi/drugs?fields=drugs.DRILL_FIELD_Institution_total_drugs_issued_30_days*"
  # }
}

# set: DRILL_FIELD_Community_total_drugs_issued_30_days{
#   fields: [
#     citizen_district_name
#     ,total_drugs_issued_30_days
#   ]
# }

# set: DRILL_FIELD_Institution_total_drugs_issued_30_days{
#   fields: [
#     user_district_name
#     ,total_drugs_issued_30_days
#   ]
