view: diseases {
  sql_table_name: `staging-tnphr.KPI.diseases`
    ;;
  ...
  measure: refferal_count {
    ...
    # link: {
    #   label: "Community"
    #   url: "/explore/tnphr_kpi/diseases?fields=diseases.DRILL_FIELD_Community_refferal_count*"
    # }
    # link: {
    #   label: "Institution"
    #   url: "/explore/tnphr_kpi/diseases?fields=diseases.DRILL_FIELD_Institution_refferal_count*"
    # }
  }

  # set: DRILL_FIELD_Community_refferal_count{
  #   fields: [
  ...
  # set: DRILL_FIELD_Institution_refferal_count{
  #   fields: [
  #     user_district_name
  #     ,refferal_count
  #   ]
