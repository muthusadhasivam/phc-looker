- dashboard: dph_dashboard_kpis_prod
  title: DPH Dashboard KPIs v1.0.3 Prod
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: 9FXiTiqzx6JDJagC9gXmB0
  elements:
  - title: Confirmed
    name: Confirmed
    model: tnphr
    ...
    note_display: hover
    note_text: |-
      Sum of the members (age > 18) with confirmed Diabetes Mellitus, Hypertension and both (Hypertension and Diabetes Mellitus)<br><br>
      ...
      <li>Confirmed Hypertension and DiabetesMellitus (Both) cases: Members with both dm_screening is Known DM and ht_screening is Known HT</li>
    listen:
  ...
  - title: Population (Age >18)
    ...
    note_state: collapsed
    note_display: hover
    note_text: Total count of members with age greater than 18
    listen:
      Districts: family_member_master.district_name
      Huds: family_member_master.hud_name
      Blocks: family_member_master.block_name
  ...
  - name: Diabetes Mellitus
    ...
    note_text: |-
      ...
      <li>Uncontrolled Diabetes Mellitus cases: Members with suspected DM</li><br>
    merged_queries:
    - model: tnphr
      explore: family_member_master
      type: single_value
    ...
    hidden_fields: [health_screening.Suspected_Diabetes]
  ...
  - name: Both
    ...
    note_text: |-
      ...
      <li>Uncontrolled Hypertension cases: Members with suspected HT and suspected DM</li><br>
    merged_queries:
    - model: tnphr
      explore: family_member_master
      type: single_value
    ...
    comparison_label: Confirmed Diabetes mellitus
    type: looker_donut_multiples
    hidden_fields: [health_screening.suspected_both]
    dynamic_fields: [{table_calculation: uncontrolled, label: Uncontrolled, expression: "${health_screening.Member_count}-${q1_health_screening.Member_count}",
        value_format: !!null '', value_format_name: !!null '', _kind_hint: measure,
        _type_hint: number}]
    listen:
  ...
  - name: Hypertension
    ...
    note_text: |-
      ...
      <li>Uncontrolled Hypertension cases: Members with suspected HT</li><br>
    merged_queries:
    - model: tnphr
      explore: family_member_master
      type: single_value
    ...
    comparison_label: Confirmed Diabetes mellitus
    type: looker_donut_multiples
    hidden_fields: [health_screening.suspected_Hypertension]
    dynamic_fields: [{table_calculation: uncontrolled, label: Uncontrolled, expression: "${health_screening.Member_count}-${q1_health_screening.Member_count}",
        value_format: !!null '', value_format_name: !!null '', _kind_hint: measure,
        _type_hint: number}]
    listen:
  ...
  - title: Screening (Age >18)
    ...
    note_text: Count of total screenings of members who got screened (even if there
      are multiple screenings per member) with age greater than 18
    listen:
      Districts: family_member_master.district_name
      Huds: family_member_master.hud_name
      Blocks: family_member_master.block_name
  ...
  - title: 'Diabetes vs Hypertension '
    ...
    note_display: hover
    note_text: |-
      Sum of the members with confirmed and controlled Diabetes Mellitus, Hypertension and both (Hypertension and Diabetes Mellitus) with age greater than 18<br><br>
      ...
      <li>Controlled Diabetes Mellitus cases: Members with rbs < 140 and dm_screening is Known DM</li><br>
      <li>Controlled Hypertension cases: Members with dia_bp  < 90, sys_bp < 140 and ht_screening is Known HT</li><br>
      <li>Controlled Hypertension and DiabetesMellitus (Both) cases: Members with dia_bp  < 90, sys_bp < 140, rbs < 140, dm_screening is Known DM and ht_screening is Known HT</li>
    listen:
      Districts: family_member_master.district_name
      Huds: family_member_master.hud_name
      Blocks: family_member_master.block_name
