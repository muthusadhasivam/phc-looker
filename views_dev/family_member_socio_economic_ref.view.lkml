...
#explore: family_member_socio_economic_ref {
# hidden: yes
...
view: family_member_socio_economic_ref {
  sql_table_name: cobalt-catalyst-318208.TNPHR.family_member_socio_economic_ref`
    ;;
...
view: family_member_socio_economic_ref__update_register {
  dimension: family_member_socio_economic_ref__update_register_timestamp {
    type: string
    label: "Updated Timestamp"
    sql: JSON_VALUE(family_member_socio_economic_ref__update_register, "$.timestamp") ;;
  }
  dimension: family_socio_economic_ref__update_register_user_id {
    type: string
    label: "Updated By User Id"
    sql: JSON_VALUE(family_member_socio_economic_ref__update_register, "$.user_id") ;;
  }
}
