...
view: health_screening {
  sql_table_name: `cobalt-catalyst-318208.TNPHR.health_screening`
    ;;
...
view: health_screening__drugs {
  ...
  dimension: health_screening__drugs_quantity {
    type: string
    label: "Quantity"
    sql: JSON_VALUE(health_screening__drugs, "$.quantity") ;;
  }
}
...
view: health_screening__lab_test {
  ...
  dimension: health_screening__lab_test_result_date {
    type: string
    label: "Result Date"
    sql: JSON_VALUE(health_screening__lab_test, "$.result_date") ;;
  }
...
view: health_screening__diseases_disease_list {
  ...
  dimension: health_screening__diseases_disease_list_service_id {
    type: string
    label: "Service Id"
    sql: JSON_VALUE(health_screening__diseases_disease_list, "$.service_id") ;;
  }
