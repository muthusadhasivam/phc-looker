view: user_master_last_update_date_is_not_more_than_current_ts {
  sql_table_name: `staging-tnphr.DATAQUALITY.user_master_last_update_date_is_not_more_than_current_ts`
    ;;
