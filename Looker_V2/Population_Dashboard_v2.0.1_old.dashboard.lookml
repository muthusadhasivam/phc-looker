- dashboard: population_dashboard_v2_0_1
  title: Population Dashboard v2.0.1
  layout: newspaper
  ...
  - title: Sex Ratio
    ...
    limit: 500
    dynamic_fields: [{table_calculation: sex_ratio, label: Sex Ratio, expression: "(${population.male_population}/${population.female_population})*100",
