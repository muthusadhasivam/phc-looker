- dashboard: community_covid_triaging_v1_0_5
  title: Community Covid Triaging v1.0.5
  layout: newspaper
  ...
  - name: Compliance of referral % within 7 days
    ...
    hidden_fields: [q1_compliance.compliance, q1_compliance.health_screening_last_update_date,
      ...
      health_screening.compliance_count, q1_health_screening.compliance_count, calculation_1]
    type: single_value
    series_types: {}
    column_limit: 50
    dynamic_fields: [{category: table_calculation, expression: "(${q1_health_screening.compliance_count}/${health_screening.compliance_count})*100",
