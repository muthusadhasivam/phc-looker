- dashboard: field_verification_v1_0_4
  title: Field Verification v1.0.4
  layout: newspaper
  ...
  - title: Members Status
    ...
    explore: family_master
    type: looker_column
    fields: [family_member_master.resident_status_concat, family_member_master.count]
    filters:
      family_member_master.resident_status_concat: -NULL,-"null"
    sorts: [family_member_master.resident_status_concat]
    limit: 500
    x_axis_gridlines: false
    y_axis_gridlines: true
    show_view_names: false
    ...
    show_silhouette: false
    totals_color: "#808080"
    y_axes: [{label: Count, orientation: left, series: [{axisId: family_member_master.count,
  ...
  - title: Families Added
    ...
    filters:
      family_master__update_register.family_master__update_register_user_id: "-system,-NULL"
      family_master.reside_status: Permanent
    sorts: [family_master.count desc]
    limit: 500
    custom_color_enabled: true
    show_single_value_title: true
    show_comparison: false
  ...
  - name: District's Wise Counts
    ...
    query_fields:
      ...
      - align: right
        ...
        time_interval:
        lookml_link: "/projects/looker-tnphr_state_level/files/views%2Ffamily_member_master.view.lkml?line=399"
        permanent: true
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_state_level/files/views%2Ffamily_member_master.view.lkml?line=380"
        permanent: true
        source_file: views/family_member_master.view.lkml
        source_file_path: looker-tnphr_state_level/views/family_member_master.view.lkml
        sql: "${TABLE}.member_id "
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_state_level/files/views%2Ffamily_member_master.view.lkml?line=421"
        permanent: true
        source_file: views/family_member_master.view.lkml
        source_file_path: looker-tnphr_state_level/views/family_member_master.view.lkml
        sql: "${TABLE}.member_id "
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_state_level/files/views%2Ffamily_member_master.view.lkml?line=410"
        permanent: true
        source_file: views/family_member_master.view.lkml
        source_file_path: looker-tnphr_state_level/views/family_member_master.view.lkml
        sql: "${TABLE}.member_id "
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_state_level/files/views%2Ffamily_member_master.view.lkml?line=369"
        permanent: true
        source_file: views/family_member_master.view.lkml
        source_file_path: looker-tnphr_state_level/views/family_member_master.view.lkml
        sql: "${TABLE}.member_id "
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_state_level/files/views%2Fhealth_screening.view.lkml?line=1301"
        permanent: true
      ...
      - align: left
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_state_level/files/views%2Ffamily_member_master.view.lkml?line=98"
        permanent: true
        source_file: views/family_member_master.view.lkml
        source_file_path: looker-tnphr_state_level/views/family_member_master.view.lkml
    ...
    listen:
    - Directorate Name: facility_directorate_master.directorate_name
      Huds: address_hud_master.hud_name
  ...
  - name: Hud's Wise Counts
    ...
    query_fields:
      ...
      - align: left
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_state_level/files/views%2Ffamily_member_master.view.lkml?line=150"
        permanent: true
        source_file: views/family_member_master.view.lkml
        source_file_path: looker-tnphr_state_level/views/family_member_master.view.lkml
        sql: "${TABLE}.hud_name "
  ...
  - name: Block's Wise Counts
    ...
    query_fields:
      ...
      - align: left
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_state_level/files/views%2Ffamily_member_master.view.lkml?line=67"
        permanent: true
        source_file: views/family_member_master.view.lkml
        source_file_path: looker-tnphr_state_level/views/family_member_master.view.lkml
  ...
  - name: Village's Wise Counts
    ...
    query_fields:
      ...
      - align: left
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_state_level/files/views%2Ffamily_member_master.view.lkml?line=293"
        permanent: true
        source_file: views/family_member_master.view.lkml
        source_file_path: looker-tnphr_state_level/views/family_member_master.view.lkml
  ...
  - name: Villages
    ...
    explore: family_master
    listens_to_filters: []
    field: family_master.village_name
  - name: Role Toggle
    title: Role Toggle
    type: field_filter
    default_value: ''
