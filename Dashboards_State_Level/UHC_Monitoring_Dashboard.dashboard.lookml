- dashboard: uhc_monitoring_dashboard_v1_0_3
  title: UHC Monitoring Dashboard v1.0.3
  layout: newspaper
  ...
  - title: Screened
    ...
    filters:
      health_screening.screening_values_ht_screening: '"\"Known HT\"","\"Normal\"","\"Suspected
        hypertension\""'
  ...
  - title: Total Screened
    ...
    fields: [health_screening.screening_count, health_screening.till_prev_day_screening_count]
    filters:
      health_screening.screening_values_dm_screening: '"\"Known DM\"","\"Normal\"","\"Suspected
        DM\""'
    limit: 500
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - name: District Wise
    ...
    query_fields:
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_state_level/files/views%2Fhealth_screening.view.lkml?line=952"
        permanent: true
        source_file: views/health_screening.view.lkml
        source_file_path: looker-tnphr_state_level/views/health_screening.view.lkml
        sql: "${TABLE}.member_id "
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_state_level/files/views%2Fhealth_screening.view.lkml?line=851"
        permanent: true
        source_file: views/health_screening.view.lkml
        source_file_path: looker-tnphr_state_level/views/health_screening.view.lkml
        sql: "${TABLE}.member_id "
      ...
      - align: right
        ...
        can_time_filter: false
        time_interval:
        lookml_link: "/projects/looker-tnphr_state_level/files/views%2Fhealth_screening.view.lkml?line=867"
        permanent: true
        source_file: views/health_screening.view.lkml
        source_file_path: looker-tnphr_state_level/views/health_screening.view.lkml
        sql: "${TABLE}.member_id "
