...
view: family_master {
  sql_table_name: `milky-way-galaxy-2707.TNPHR.family_master` ;;
  ...
  measure: family_count_with_unallocated_streets {
    label: "Family Count unallocated streets"
    type: count_distinct
  ...
  measure: family_count_with_unallocated_facility {
    label: "Family Count unallocated facility"
    type: count_distinct
